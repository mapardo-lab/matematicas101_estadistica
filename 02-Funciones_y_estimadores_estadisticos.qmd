...
### Media geométrica (uso financiero)
...
La varianza es un estimador sesgado y R utiliza la fórmula del estimador no sesgado (denominador N-1). Veremos que significa eso en el futuro. Es preferible utilizar el estimador no sesgado ya que se aproxima más a la varianza de la población.
